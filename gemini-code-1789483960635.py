...
def process_caderno(pu_file, template_file):
    ...
    tabela_ifap_culturas = {
        '1': '1 - TRIGO', '3': '3 - CENTEIO', '4': '4 - CEVADA', '5': '5 - AVEIA', '6': '6 - MILHO',
        '7': '7 - TRITICALE', '8': '8 - SORGO', '9': '9 - LINHO', '13': '13 - ERVILHA', '14': '14 - FAVA',
        '17': '17 - GIRASSOL', '18': '18 - SOJA', '24': '24 - ARROZ', '26': '26 - OUTROS CEREAIS',
        '29': '29 - CANA DE AÇÚCAR', '32': '32 - BETERRABA', '33': '33 - TOMATE', '34': '34 - VINHA',
        '35': '35 - LUPULO', '38': '38 - GRÃO DE BICO', '42': '42 - TABACO', '44': '44 - LUZERNA',
        '46': '46 - TREVO', '47': '47 - TREMOÇO', '48': '48 - ERVILHACA', '59': '59 - ALGODÃO',
        '60': '60 - OUTRAS CULTURAS PERMANENTES', '67': '67 - AZEVEM', '78': '78 - PIMENTO',
        '81': '81 - PLANTAS AROM., MEDICINAIS E CONDIMENTARES', '83': '83 - OLIVAL',
        '84': '84 - POMARES MISTOS DE FRUTOS FRESCOS', '85': '85 - FIGO', '86': '86 - OUTROS FRUTOS SECOS',
        '89': '89 - POUSIO', '90': '90 - OUTRAS HORTÍCOLAS', '91': '91 - FLORES E PLANTAS ORNAMENTAIS',
        '93': '93 - PERA', '94': '94 - PÊSSEGO', '96': '96 - LARANJA', '97': '97 - LIMÃO',
        '101': '101 - VIVEIROS', '102': '102 - OUTROS FRUTOS SUB-TROPICAIS', '103': '103 - BATATA',
        '105': '105 - MAÇÃ', '106': '106 - CEREJA', '107': '107 - DAMASCO', '108': '108 - AMEIXA',
        '109': '109 - AMENDOA', '110': '110 - CASTANHA', '111': '111 - ALFARROBA', '112': '112 - NOZ',
        '114': '114 - VIME', '115': '115 - CHA', '116': '116 - AVELÃ', '117': '117 - OUTROS PEQUENOS FRUTOS',
        '118': '118 - MARMELO', '119': '119 - NÊSPERA', '124': '124 - KIWI', '125': '125 - GALERIA RIPÍCOLA',
        '126': '126 - SALIX (MADEIRA)', '127': '127 - BATATA DOCE', '128': '128 - INHAME', '130': '130 - AMENDOIM',
        '131': '131 - MEDRONHEIRO', '132': '132 - ANANÁS', '133': '133 - BANANA', '134': '134 - PISTACIOS',
        '135': '135 - PINHÃO', '136': '136 - ABACATE', '137': '137 - BERINGELA', '139': '139 - BOSQUETES',
        '142': '142 - PRADOS TEMPORÁRIOS', '143': '143 - PASTAGENS PERMANENTES', '148': '148 - OUTRAS LEGUMINOSAS SECAS',
        '151': '151 - ANONA', '155': '155 - TANGERINA', '156': '156 - OUTRAS OLEAGINOSAS', '157': '157 - OUTROS CITRINOS',
        '161': '161 - MISTO CULTURAS PERMANENTES', '162': '162 - POVOAMENTO DE SOBREIROS', '163': '163 - POVOAMENTO AZINHEIRAS',
        '164': '164 - POVOAMENTO CARVALHO NEGRAL', '165': '165 - POVOAMENTO MISTO QUERCUS(SOB.AZENH.CARVAL/NEGRAL)',
        '166': '166 - POVOAMENTO CASTANHEIRO', '167': '167 - POVOAMENTO OUTRAS FOLHOSAS', '168': '168 - POVOAMENTO DE PINHEIRO MANSO',
        '169': '169 - POVOAMENTO OUTRAS RESINOSAS', '170': '170 - POVOAMENTO F MISTO', '173': '173 - ACEIRO FLORESTAL',
        '174': '174 - OUTRAS SUPERFÍCIES FLORESTAIS', '190': '190 - MACIÇOS OU FORMAÇÕES RELIQUIAIS OU NOTÁVEIS',
        '195': '195 - OUTRAS FRUTOS FRESCOS', '201': '201 - AMORA', '202': '202 - MIRTILO', '203': '203 - FRAMBOESA',
        '204': '204 - MORANGO', '205': '205 - MELÃO', '208': '208 - DIOSPIRO', '209': '209 - ROMÃ',
        '210': '210 - POVOAMENTO DE EUCALIPTO', '211': '211 - GINJA', '223': '223 - SABUGUEIRO (BAGA)',
        '230': '230 - FEIJÃO', '231': '231 - MELANCIA', '232': '232 - MELOA', '233': '233 - NABO',
        '234': '234 - PEPINO', '236': '236 - RABANETE', '237': '237 - RÁBANO', '238': '238 - RUTABAGA',
        '240': '240 - TREMOCILHA', '241': '241 - ABÓBORAS E ABOBORINHAS', '242': '242 - AGRIÃO', '244': '244 - ALFACE',
        '245': '245 - ALHO', '248': '248 - CEBOLA', '249': '249 - CENOURA', '250': '250 - COURGETTE',
        '254': '254 - COUVE', '261': '261 - TANGERA', '262': '262 - SOBREIRO PARA PRODUÇÃO DE CORTIÇA',
        '263': '263 - CHUCHU', '264': '264 - COLZA', '265': '265 - SUPERFÍCIE ARBUSTIVA NÃO PASTOREÁVEL',
        '266': '266 - CONSOCIAÇÃO DE FIXADORAS DE AZOTO', '267': '267 - CONSOCIAÇÕES ANUAIS E OUTRAS CULT. FORRAG. ANUAIS',
        '268': '268 - GALERIA RIPÍCOLA FLORESTAL', '269': '269 - MARACUJÁ', '276': '276 - MOSTARDA', '277': '277 - NABIÇA',
        '279': '279 - RÚCULA', '280': '280 - PASTAGENS ARBUSTIVAS', '281': '281 - PASTAGENS EM BALDIO', '283': '283 - MEDRONHO',
        '284': '284 - PAPAIA', '285': '285 - FIGO DA INDIA', '286': '286 - GROSELHA', '287': '287 - SERRADELA',
        '288': '288 - FESTUCA', '289': '289 - PANASCO', '290': '290 - BROMUS', '291': '291 - MARALFALFA',
        '292': '292 - ANAFA', '293': '293 - ALHO FRANCÊS', '298': '298 - MANGA', '299': '299 - GOIABA',
        '300': '300 - TALUDE DA VINHA', '301': '301 - CULTURAS EM HIDROPONIA', '302': '302 - CULTURAS SEM SOLO',
        '304': '304 - TRIGO SPELTA', '305': '305 - ESPINAFRE', '914': '914 - ELEMENTO LINEAR SEBE OU CORTA-VENTO-ÁREA ÚTIL',
        '924': '924 - ELEMENTO LINEAR EM ORIZICULTURA-ÁREA ÚTIL', '925': '925 - GALERIA RIPÍCOLA - ÁREA ÚTIL',
        '939': '939 - EP-BOSQUETE E FORMAÇÕES RELIQUIAIS-ÁREA ÚTIL', '982': '982 - CABECEIRAS CULT. PERMANENTES -ÁREA ÚTIL',
        '985': '985 - LINHAS DE ÁGUA - ÁREA ÚTIL', '986': '986 - ELP CHARCAS E LAGOAS - ÁREA ÚTIL'
    }
    ...
    # Dicionário estrito de Intervenções
    code_mapping = {
        'C.1.1.1.1.1': 'SD', 'C.1.1.1.1.2': 'ENR', 'C.1.1.1.1.3': 'PB', 'C.1.1.1.2': 'UEA-Água',
        'C.1.1.2': 'MSE', 'C.1.1.2.1': 'ML', 'C.1.1.2.2': 'CPPT',
        'C.1.1.2.2.1.1': 'OLI-TRAD', 'C.1.1.2.2.1.2': 'FIG-EXT', 'C.1.1.2.2.1.3': 'POM-TRAD',
        'C.1.1.2.2.1.4': 'AMEND-EXT', 'C.1.1.2.2.1.5': 'CAST-EXT', 'C.1.1.2.3': 'MA',
        'C.1.1.3': 'CB', 'C.1.1.4': 'GAPB', 'C.1.1.5': 'CMRGF', 'C.1.1.6': 'APIO',
        'C.1.1.7': 'PRODI', 'C.1.1.8': 'AB', 'C.1.1.8.1': 'AB-C', 'C.1.1.8.2': 'AB',
        'C.1.2.1': 'ZM', 'C.1.2.2': 'RN', 'C.1.2.3': 'ZCNE',
        'A.3.3': 'ECO-BIO', 'A.3.4': 'MSPP', 'A.3.5': 'MEAF', 'A.3.6': 'CERT',
        'D.2.1': 'PZA', 'D.2.4': 'PE-AVES', 'D.2.5': 'PE-SILVO'
    }
    ...
    # 1. Ajuste da linha inicial de escrita na folha 2 para evitar apagar o cabeçalho
    # Começa na linha 9 em vez de 8
    ws2 = wb['2 Caraterização área sob comp.']
    for row_idx, row_data in enumerate(df_final[cols].values, start=9):
    ...
    # O bloco de interação com a Folha 5A (Fertilizações) foi TOTALMENTE REMOVIDO para que fique vazia/intacta.
    ...
    for i, row in zonas.iterrows():
        ...
        # 2. Ajuste de colunas (+1) na folha 4 e folha 5 para não apagar/escrever em cima dos títulos do cabeçalho
        safe_write(ws4, offset+5, 3, row['Zona Homogénea'])  # Coluna ajustada
        safe_write(ws4, offset+5, 5, round(row['Área (ha)'], 2)) # Coluna ajustada
        safe_write(ws4, offset+5, 8, get_rega(cult, row.get('Regadio', 'S'))) # Coluna ajustada
        safe_write(ws4, offset+7, 4, cult) # Coluna ajustada
        if esp != "":
            safe_write(ws4, offset+11, 5, esp) # Coluna ajustada
    ...
    if num_zonas_5 > 0:
        ...
        for i, row in zonas_5.iterrows():
            ...
            safe_write(ws5, offset+5, 3, row['Zona Homogénea']) # Coluna ajustada
            safe_write(ws5, offset+5, 13, round(row['Área (ha)'], 2)) # Coluna ajustada
            safe_write(ws5, offset+7, 3, cult) # Coluna ajustada
            safe_write(ws5, offset+9, 15, get_rega(cult, row.get('Regadio', 'S'))) # Coluna ajustada
            if esp != "":
                safe_write(ws5, offset+12, 5, esp) # Coluna ajustada
